...
public class Main {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			System.out.println("Enter Date of Crime (yyy-mm-dd)");
			...
			System.out.println("Enter Status of Crime ('Solved', 'Not_Solved')");
		...
		case 5:
			try {
				...
				System.out.println("====================");
				System.out.println("## Victim's List ##");
				System.out.println("====================");
...
//			System.out.println(crimes);
		...
		break;
		case 7:
			System.out.println("=*=*=*=*=*=*=Thank_You_for_using_Software_System=*=*=*=*=*=*=");
			break;
		}
		if(x==7) break;
	}
